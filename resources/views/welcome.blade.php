...
<head>
  ...
  <link rel="shortcut icon" href="{{ asset('landing/images/fevicon.png')}}" type="">
  ...
  <div class="hero_area">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav  ">
                <li class="nav-item">
                    @if (Route::has('login'))
                        @auth
                            <a class="nav-link" href="{{ url('/dashoard') }}"> <i class="fa fa-arrow-right" aria-hidden="true"></i> Dashboard</a>
                        @else
                            <a class="nav-link" href="{{ route('login') }}"> <i class="fa fa-user" aria-hidden="true"></i> Login</a>
                        {{-- @if (Route::has('register'))
                            <a class="nav-link" href="{{ route('register') }}"> <i class="fa fa-circle-user" aria-hidden="true"></i> Register</a>
                        @endif --}}
                        @endauth
                    @endif
                </li>
    ...
    <section class="slider_section ">
      <div class="slider_bg_box">
        <img src="{{ asset('landing/images/slider-bg.jpg')}}" alt="">
      </div>
  ...
  <section class="about_section layout_padding-bottom">
    <div class="container  ">
      <div class="row">
        ...
        <div class="col-md-6 ">
          <div class="img-box">
            <img src="{{ asset('landing/images/about-img.jpg')}}" alt="">
          </div>
        </div>
